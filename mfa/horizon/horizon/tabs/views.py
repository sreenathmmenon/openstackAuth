...
class TabbedTableView(tables.MultiTableMixin, TabView):
    ...
    def get(self, request, *args, **kwargs):
        print('get function inside Tabs. Class -TabbedTabView')
        self.load_tabs()
